      ...
      <>
        <section id="project" className="section project" >
          ...
          <div className="section__content">
            ...
            <div className="project__content" type="primary" onClick={this.showModal}>
          ...
          <div className="section__content">
            ...
            <div className="project__content" type="primary" onClick={this.showModal2}>
          ...
          <div className="section__content">
            ...
            <div className="project__content" type="primary" onClick={this.showModal3}>
